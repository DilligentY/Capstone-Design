...
parser.add_argument("--checkpoint", type=str, default="C:/IsaacLab/logs/skrl/quadcopter_direct/2025-03-22_14-09-50_ppo_torch/checkpoints/agent_480000.pt", help="Path to model checkpoint.")
parser.add_argument(
